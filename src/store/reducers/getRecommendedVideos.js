...
export const getRecommendedVideos = createAsyncThunk(
    ...
    async(videoId,{getState}) => {
        ...
        const response = await axios.get(`https://youtube.googleapis.com/youtube/v3/activities?&key=${API_KEY}&channelId=${channelId}&part=snippet,contentDetails&maxResults=1000&type=videoId=${videoId}`);
